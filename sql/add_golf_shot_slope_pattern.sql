-- Run in Supabase SQL Editor (or migrate) so PostgREST accepts slope_pattern on inserts.
-- Adds queryable uphill/downhill putt segments (mirrors break_pattern chip data).
